...
const StateSkeleton = ({ image, title, message, button }: StateSkeletonProps) => {
    return (
        <div className={`mt-16 flex w-full flex-col items-center justify-center sm:mt-36`}>
            <>
                <Image src={image.dark} alt={image.alt} width={270} height={270} className={`hidden object-contain dark:block`} />
                <Image src={image.light} alt={image.alt} width={270} height={270} className={`block object-contain dark:hidden`} />
            </>
