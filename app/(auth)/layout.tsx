...
const RootLayout = ({children}: { children: ReactNode }) => {
    return (
        <main
            ...
            <section
                className={`light-border background-light800_dark200 shadow-light100_dark100 min-w-full rounded-[10px] border px-10 py-10 shadow-md sm:min-w-[520px] sm:px-8`}>
                <div className={`flex items-center justify-between gap-2`}>
                    ...
                    <Image src={'images/site-logo.svg'} alt={`StudyFlow`} width={50} height={50}
